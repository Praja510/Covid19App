package com.muhammadprajadinata.covid19app.adapter
...
import com.muhammadprajadinata.covid19app.R
...
class CountryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    fun bind(negara: CountriesItem, clickListener: (CountriesItem) -> Unit) {
        ...
        val country_totalDeath: TextView = itemView.tv_countrTotalDeath
        ...
        country_totalDeath.tv_countrTotalDeath.text =
